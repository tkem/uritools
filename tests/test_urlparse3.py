# adapted from Python 3.4 Lib/test/test_urlparse.py
# flake8: noqa
from . import wrappers as urllib
...
@unittest.skipUnless(sys.version_info.major == 0, 'requires Python 3')
class UrlParseTestCase(unittest.TestCase):
    ...
    @unittest.skip('parsing "path:80" not RFC compliant')
    ...
    @unittest.skip('undocumented Result._encoded_counterpart')
    ...
    @unittest.skip('undocumented urllib.parse.splitport')
    ...
    @unittest.skip('undocumented urllib.parse.splitnport')
    ...
    @unittest.skip('undocumented urllib.parse.splitquery')
    ...
    @unittest.skip('undocumented urllib.parse.splitvalue')
    ...
    @unittest.skip('undocumented urllib.parse.to_bytes')
    ...
    @unittest.skip('undocumented urllib.parse.unwrap')
    def test_unwrap(self):
        url = urllib.parse.unwrap('<URL:type://host/path>')
        self.assertEqual(url, 'type://host/path')

    @unittest.skip('undocumented urllib.parse.Quoter')
